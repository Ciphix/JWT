 ...
 */
public class GenerateRSAPrivateKey extends UserAction<IMendixObject>
{
	private final java.lang.String modulus;
	private final java.lang.String privateExponent;

	public GenerateRSAPrivateKey(
		IContext context,
		java.lang.String _modulus,
		java.lang.String _privateExponent
	)
	{
		super(context);
		this.modulus = _modulus;
		this.privateExponent = _privateExponent;
	}
